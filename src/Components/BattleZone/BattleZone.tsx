...
//Component som bestämmer hur en enskild zon ser ut samt vad som händer när användaren klickar.
const BattleZone = ({showShips, id,playerOne,playerTwo,shipPlacedByPlayerOne,shipPlacedByPlayerTwo,successfullHitFromPlayerOne,successfullHitFromPlayerTwo,failedHitFromPlayerOne,failedHitFromPlayerTwo,handleShipPlacement,handlePlayerFire}: Props) => {
